...
Если вы реконструируете отдельно ipv6 header и не используете вариант ip6_preserve_next, невозможно автоматически узнать что вы хотите вписать в последний exthdr.
Туда вписывается ip6_last_proto, либо IPPROTO_NONE, если ip6_last_proto не задан.
